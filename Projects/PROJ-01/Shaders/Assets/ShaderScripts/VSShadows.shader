Shader "Unlit/VSShadows"
{
    ...
    SubShader
    {
        Pass
        {
            ...
            #pragma multi_compile_fwdbase nolightmap nodirlightmap nodynlightmap novertextlight
...
// If you're going to start using properties from the lights, then you'll need to include that file.
        ...
        Pass
        {
            ...
            v2f vert(appdata v){
                v2f o;
                TRANSFER_SHADOW_CASTER_NORMALOFFSET(o)  //creating shadow for you
                return o;
            }
            float4 frag(v2f i): SV_Target{
                SHADOW_CASTER_FRAGMENT(i) //spits out pixel color of shadow
            }
            ENDCG
        }
    }
